...
<div class="container py-4">
  ...
  <c:if test="${param.approved == '1'}"><div class="alert alert-success">Loan approved.</div></c:if>
  <c:if test="${param.rejected == '1'}"><div class="alert alert-warning">Loan rejected.</div></c:if>
