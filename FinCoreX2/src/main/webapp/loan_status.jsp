            ...
            <div class="container-fluid">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0"><i class="fas fa-list me-2"></i>Loan Details</h5>
                    </div>
                    <div class="card-body">
                        <c:choose>
                                        ...
                                        <tbody>
                                            <c:forEach var="loan" items="${loans}">
                                                <tr>
                                                    <td>${loan.loanId}</td>
                                                    <td>${loan.loanType}</td>
                                                    <td><fmt:formatNumber value="${loan.amount}" type="currency" currencySymbol="₹" maxFractionDigits="2" /></td>
                                                    <td><fmt:formatNumber value="${loan.interestRate}" maxFractionDigits="2" />%</td>
                                                    <td>${loan.tenureMonths}</td>
                                                    <td><fmt:formatDate value="${loan.appliedDate}" pattern="dd-MM-yyyy" /></td>
                                                    <td>
                                                        <c:choose>
