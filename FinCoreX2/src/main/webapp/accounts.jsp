    ...
    <div class="d-flex">
        ...
        <main class="flex-grow-1 p-4">
            <div class="container-fluid">
                <!-- Page Title -->
                <h3 class="mb-4 text-primary"><i class="fas fa-wallet me-2"></i>My Accounts</h3>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <c:if test="${empty accounts}">
                            <p class="text-muted">You have no accounts yet. Open one below!</p>
                            <%
                                System.out.println("No accounts found for customerId: " + (session.getAttribute("customer") != null ? ((com.tss.model.Customer)session.getAttribute("customer")).getCustomerId() : "null"));
                            %>
                        </c:if>
                            ...
                            <div class="accordion-body">
                                <form class="row g-3" method="post" action="${pageContext.request.contextPath}/customer/open-account">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end">
                                        <button class="btn btn-primary w-100" type="submit"><i class="fas fa-plus me-2"></i>Open</button>
                                    </div>
                                </form>
                            </div>
                        </div>
