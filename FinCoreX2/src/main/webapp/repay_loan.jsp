    ...
    <div class="d-flex flex-grow-1">
        ...
        <main class="flex-grow-1 p-4">
            <div class="container-fluid">
                <h3 class="mb-4 text-primary"><i class="fas fa-money-check-alt me-2"></i>Repay Loan</h3>
                    ...
                    <div class="card-body">
                        <form class="row g-3" method="post" action="${pageContext.request.contextPath}/customer/loan/repay">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                <button class="btn btn-success w-100" type="submit"><i class="fas fa-check me-2"></i>Repay</button>
                            </div>
                        </form>
                    </div>
                </div>
